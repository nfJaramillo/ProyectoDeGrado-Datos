...
df = pd.read_csv("Datos/depositsToRouters(video).csv", index_col="date")
...
bcr.bar_chart_race(
    ...
    filename="depositsTo(Routers).mp4",
    ...
    # Depósitos a Smart Contracts Routers de Tornado Cash (Acumulado)
    title={'label': 'Depósitos a Smart Contracts Routers',
           'size': 52,
           'weight': 'bold',
           'pad': 40, 
           'family': 'Nunito'
