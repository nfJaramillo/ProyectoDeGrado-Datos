...
df = pd.read_csv("Datos/depositsToFinal(video).csv", index_col="date")
...
bcr.bar_chart_race(
    ...
    # Depósitos a Smart Contracts Finales de Tornado Cash (Acumulado)
    title={'label': 'Depósitos a Smart Contracts Finales',
           'size': 52,
           'weight': 'bold',
           'pad': 40, 
           'family': 'Nunito'
