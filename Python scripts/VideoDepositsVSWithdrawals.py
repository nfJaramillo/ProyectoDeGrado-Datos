...
df = pd.read_csv("Datos/Deposits vs Withdrawals Final (Video).csv")
...
bcr.bar_chart_race(
    ...
    filename="Deposits vs Withdrawals (Final).mp4",
    ...
    # Depósitos vs retiros a Smart Contracts Finales de Tornado Cash
    title={'label': 'Depósitos vs retiros',
           'size': 52,
           'weight': 'bold',
           'pad': 40, 
           'family': 'Nunito'
