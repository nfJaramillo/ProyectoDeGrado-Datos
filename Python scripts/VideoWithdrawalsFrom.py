...
df = pd.read_csv("Datos/withdrawalsFromTop(video).csv")
...
bcr.bar_chart_race(
    ...
    # title and its styles
     # Top 10 Smart Contracts que retiraron de Tornado Cash (Acumulado)
    title={'label': 'Top 10 Smart Contracts que retiraron',
           'size': 52,
           'weight': 'bold',
           'pad': 40, 
           'family': 'Nunito'
