...
df = pd.read_csv("Datos/withdrawalsToFinal(video).csv")
...
bcr.bar_chart_race(
    ...
    filename="withdrawalsTo(Final).mp4",
    ...
    # Retiros de Smart Contracts Finales de Tornado Cash (Acumulado)
    title={'label': 'Retiros de Smart Contracts Finales',
           'size': 52,
           'weight': 'bold',
           'pad': 40, 
           'family': 'Nunito'
