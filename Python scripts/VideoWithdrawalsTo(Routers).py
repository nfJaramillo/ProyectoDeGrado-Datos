...
df = pd.read_csv("Datos/withdrawalsToRouters(video).csv")
...
bcr.bar_chart_race(
    ...
    filename="withdrawalsTo(Routers).mp4",
    ...
    # Retiros de Smart Contracts Routers de Tornado Cash (Acumulado)
    title={'label': 'Retiros de Smart Contracts Routers',
           'size': 52,
           'weight': 'bold',
           'pad': 40, 
           'family': 'Nunito'
